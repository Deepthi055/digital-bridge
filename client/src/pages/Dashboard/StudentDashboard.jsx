    ...
    <div style={{ minHeight: '100vh', background: 'linear-gradient(120deg, #a8c0ff 0%, #f8fafc 100%)', display: 'flex' }}>
      ...
      <div style={{ flex: 1, padding: '2rem 0', minWidth: 0, background: 'linear-gradient(120deg, #f8fafc 60%, #eafcff 100%)' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 1rem' }}>
          {/* Welcome Section */}
          <div style={{ background: 'rgba(255,255,255,0.97)', borderRadius: 18, boxShadow: '0 2px 12px #646cff22', padding: '2rem 2rem 1.2rem 2rem', marginBottom: 28, display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 32, marginBottom: 36, justifyContent: 'center' }}>
            <div style={{ flex: 2, minWidth: 260, background: '#f8fafc', borderRadius: 16, boxShadow: '0 2px 12px #646cff22', padding: '1.5rem 1.2rem', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              <h3 style={{ color: '#646cff', fontWeight: 800, fontSize: '1.1rem', marginBottom: 12 }}>Progress Overview</h3>
              <div style={{ position: 'relative', width: 110, height: 110, marginBottom: 10 }}>
                <svg width={110} height={110}>
                  ...
                  />
                  <text x="50%" y="54%" textAnchor="middle" fontSize="1.5rem" fontWeight="bold" fill="#646cff">{percentComplete}%</text>
                </svg>
              </div>
              <div style={{ color: '#333', fontSize: 15, marginBottom: 4 }}>{completed} completed, {inProgress} in progress</div>
              <div style={{ color: '#aaa', fontSize: 13 }}>Across {total} courses</div>
            </div>
            <div style={{ flex: 1, minWidth: 200, background: '#eafcff', borderRadius: 16, boxShadow: '0 2px 12px #00b89422', padding: '1.5rem 1.2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
              <h3 style={{ color: '#00b894', fontWeight: 800, fontSize: '1.1rem', marginBottom: 12 }}>Certificates</h3>
              <span style={{ fontSize: 38, marginBottom: 8 }}><FaCertificate size={38} color="#00b894" /></span>
              <div style={{ color: '#00b894', fontWeight: 700, fontSize: 22 }}>{certificates}</div>
              <div style={{ color: '#333', fontSize: 14 }}>Earned</div>
            </div>
          </div>
