      ...
      <div style={{ flex: 1, padding: '2rem 0', minWidth: 0, background: 'linear-gradient(120deg, #f8fafc 60%, #eafcff 100%)' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 1rem' }}>
          {activeSidebar === 'Dashboard' && (
            ...
            {/* End Dashboard main content fragment */}
          ...
          {activeSidebar === 'Enrolled Courses' && (
            <div style={{ background: '#fff', borderRadius: 16, boxShadow: '0 2px 12px #646cff11', padding: '2rem', marginBottom: 28 }}>
              <h2 style={{ color: '#646cff', fontWeight: 800, fontSize: '1.3rem', marginBottom: 18, letterSpacing: 1 }}>Current Courses</h2>
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 28, justifyContent: 'center', marginBottom: 0 }}>
                {currentCourses.length === 0 && <div style={{ color: '#aaa', fontSize: 16 }}>No current courses. Start a new one!</div>}
                {currentCourses.map((course, idx) => (
          ...
          {activeSidebar === 'Mentor Connect' && (
            <div style={{ background: '#fff', borderRadius: 16, boxShadow: '0 2px 12px #646cff11', padding: '2rem', marginBottom: 28 }}>
              <h2 style={{ color: '#646cff', fontWeight: 800, fontSize: '1.3rem', marginBottom: 18, letterSpacing: 1 }}>Mentor Connect</h2>
              <div style={{ color: '#333', fontSize: 16 }}>Connect with mentors and get guidance here.</div>
            </div>
          )}
          {activeSidebar === 'Assignments / Tasks' && (
            <div style={{ background: '#fff', borderRadius: 16, boxShadow: '0 2px 12px #646cff11', padding: '2rem', marginBottom: 28 }}>
              <h2 style={{ color: '#646cff', fontWeight: 800, fontSize: '1.3rem', marginBottom: 18, letterSpacing: 1 }}>Assignments / Tasks</h2>
              <div style={{ color: '#333', fontSize: 16 }}>Your assignments and tasks will be shown here.</div>
            </div>
          )}
          {activeSidebar === 'Certificates' && (
            <div style={{ background: '#fff', borderRadius: 16, boxShadow: '0 2px 12px #646cff11', padding: '2rem', marginBottom: 28 }}>
              <h2 style={{ color: '#00b894', fontWeight: 800, fontSize: '1.3rem', marginBottom: 18, letterSpacing: 1 }}>Completed Courses & Certificates</h2>
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 28, justifyContent: 'center', marginBottom: 0 }}>
                {completedCourses.length === 0 && <div style={{ color: '#aaa', fontSize: 16 }}>No completed courses yet.</div>}
                {completedCourses.map((course, idx) => (
                  <div
          ...
          {activeSidebar === 'Suggested Courses' && (
            <div style={{ background: '#fff', borderRadius: 16, boxShadow: '0 2px 12px #646cff11', padding: '2rem', marginBottom: 28 }}>
              <h2 style={{ color: '#646cff', fontWeight: 800, fontSize: '1.3rem', marginBottom: 18, letterSpacing: 1 }}>Recommended Courses</h2>
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 18, justifyContent: 'center', marginBottom: 0 }}>
                {recommendedCourses.map((course, idx) => (
                  <div key={idx} style={{
                    width: 250,
          ...
          {activeSidebar === 'My Profile' && (
            <div style={{ background: '#fff', borderRadius: 16, boxShadow: '0 2px 12px #646cff11', padding: '2rem', marginBottom: 28 }}>
              <h2 style={{ color: '#646cff', fontWeight: 800, fontSize: '1.3rem', marginBottom: 18, letterSpacing: 1 }}>My Profile</h2>
              <div style={{ color: '#333', fontSize: 16 }}>Your profile information will be shown here.</div>
            </div>
          )}
          {activeSidebar === 'Help & Support' && (
            <div style={{ background: '#fff', borderRadius: 16, boxShadow: '0 2px 12px #646cff11', padding: '2rem', marginBottom: 28 }}>
              <h2 style={{ color: '#646cff', fontWeight: 800, fontSize: '1.3rem', marginBottom: 18, letterSpacing: 1 }}>Help & Support</h2>
              <div style={{ color: '#333', fontSize: 16 }}>Get help and support here.</div>
            </div>
          )}
        </div>
      </div>
